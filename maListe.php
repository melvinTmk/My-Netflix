...
<br>
		...
		<div class="menu">
            ...
            <br><br><br><br><br><br>
            <h1 style="text-align:center; font-size:3em; color:white;">Mes Favoris </h1>
            <br><br><br>
<?php

if(!empty($_GET['action']))
{
    if($_GET['action']=='supprFav')
     {
        $id = $_GET['id'];
        $id_membre = $_SESSION['id'];

        $sql = 'DELETE FROM favoris WHERE id_membre = ? and id_serie = ?';
...
<td>'.$ligne['thematique'].'</td>
 <td> 
    ...
    <a href="maListe.php?action=supprFav&id='.$ligne['id'].'"><i class="fas fa-trash-alt" "></i> </a> 
    </td>
</tr>'
;
};
